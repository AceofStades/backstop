...
| `cli.py` | 551 | Seven commands |
| `adapters/` | 391 | Three leaks + registration plumbing |
| `harness/` | 2145 | Assignment, response model, runner, metrics, replication, uplift sensitivity, HTML readout, scenarios |
| `tests/` | 1290 | 148 tests |
